                    ...
                    <form class="mascaramensajes" action="{{ route( 'eliminarMensajes' ) }}" method="post">  
                        ...
                        <div id="contenedor_mensajes">
                            ...
                            <div class="mesage">
                                ...
                                <pre class="mesage_content" style="font-family: quicksand; text-align: justify; text-justify: inter-word; white-space: pre-line; word-break: break-word;">{{ $mensaje->FM_TEXTO }}</pre>
                                <div class="opciones_mensajes">
