    ...
    <div id="body_home">     
        <div id="contenido" class="container-fluid">
            ...
            <div class="home container">
                ...
                <label class="welcome_left container-fluid">Bienvenidos a FUDEBIOL</label>


                <div class="subseccion container-fluid">
                     <div id="home_texto" class="container-fluid">El Centro Biológico Las Quebradas, situado a 136 kilómetros al sur de San José, es una reserva natural comunal administrada por FUDEBIOL. Se ubica en la cuenca del Río San Isidro cuya altitud esta entre los 1100 y los 2400 m.s.n.m. formando parte de las estribaciones de la Cordillera de Talamanca, sector Pacífico.
                    ...
                    <img class="img_izquierda img-responsive" src="/img/fudehome.jpg">
                </div>
                ...
                <div class="subseccion container-fluid">
                    <img class="img_derecha img-responsive" src="/img/educacion.jpg">
                ...
                <div class="subseccion container-fluid">
                    <img class="img_derecha img-responsive" src="/img/entorno.jpg">
        ...
        <div id="pie" class="container-fluid">
            <div class="bottom container-fluid">
                <div class="left container-fluid">
                    <img class="logo img-responsive" src="img/vector.png"></img>
                    <div class="sitename container-fluid">&copy;FUDEBIOL</div>
                </div>
