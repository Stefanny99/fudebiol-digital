            ...
            <div class="home">
                ...
                <div class="subseccion">
                     <div id="home_texto">El Centro Biológico Las Quebradas, situado a 136 kilómetros al sur de San José, es una reserva natural comunal administrada por FUDEBIOL. Se ubica en la cuenca del Río San Isidro cuya altitud esta entre los 1100 y los 2400 m.s.n.m. formando parte de las estribaciones de la Cordillera de Talamanca, sector Pacífico.
                        ...
                        <div class= "bg2"><img class="img_izquierda img-responsive" src="{{ asset( '/img/fudehome.jpg' ) }}"> </div>
                    </div>
                </div>
                <div class="seccion">
                <label class="welcome_right">Educación</label>
                <div class="subseccion">
                    <div class= "bg2"><img class="img_derecha img-responsive" src="{{ asset( '/img/educacion.jpg' ) }}"></div>
                ...
                <div class="subseccion">
                     ...
                     <div class= "bg2"><img class="img_izquierda img-responsive" src="{{ asset( '/img/voluntariado.jpg' ) }}"></div>
                </div>
                ...
                <div class="seccion">
                    ...
                    <div class="subseccion">
                    <div class= "bg2"><img class="img_derecha img-responsive" src="{{ asset( '/img/entorno.jpg' ) }}"></div>
